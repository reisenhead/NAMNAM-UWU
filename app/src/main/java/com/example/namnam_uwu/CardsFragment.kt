...
class CardsFragment : Fragment() {
    ...
    private fun getProducts(): MutableList<Product>{
        ...
        products.add(Product("Paquet Fruta",            "Amamba",               "5",    "10:00-20:00",      "Mañana",         "4",    "3.5","$40","$122",R.drawable.amamba4))
        products.add(Product("Molletes",                "Amamba",               "3",    "10:00-20:00",      "Mañana",         "4",    "2.5","$38","$125",R.drawable.amamba5))
        products.add(Product("Jugo buena digestión",    "Cachito mío",          "8",    "9:00-18:00",       "Mañana",         "3",    "2.0","$50","$110",R.drawable.cachito1))
        products.add(Product("Coctel de Frutas",        "Cachito mío",          "9",    "9:00-18:00",       "Mañana",         "3",    "3.5","$45","$140",R.drawable.cachito2))
        products.add(Product("Paquete Coctel",          "Cachito mío",          "4",    "9:00-18:00",       "Mañana",         "6",    "4.0","$49","$110",R.drawable.cachito3))
        products.add(Product("Paquet Fruta",            "Cachito mío",          "11",   "10:00-20:00",      "Mañana",         "8",    "4.0","$59","$120",R.drawable.cachito4))
        products.add(Product("Molletes",                "Cachito mío",          "12",   "10:00-20:00",      "Mañana",         "5",    "4.0","$39","$130",R.drawable.cachito5))
        products.add(Product("Jugo buena digestión",    "La Docena",            "3",    "10:00-20:00",      "Mañana",         "4",    "4.0","$40","$140",R.drawable.docena1))
        products.add(Product("Coctel de Frutas",        "La Docena",            "4",    "10:00-20:00",      "Hoy",            "1",    "4.5","$33","$130",R.drawable.docena2))
        products.add(Product("Paquete Coctel",          "La Docena",            "2",    "10:00-20:00",      "Hoy",            "10",   "4.5","$30","$130",R.drawable.docena3))
        products.add(Product("Paquet Fruta",            "La Docena",            "2",    "9:00-18:00",       "Hoy",            "6",     "4.5","$30","$130",R.drawable.docena4))
        products.add(Product("Molletes",                "La Docena",            "2",    "10:00-20:00",      "Mañana",         "7",     "4.5","$30","$130",R.drawable.docena5))
        products.add(Product("Jugo buena digestión",    "Forever",              "2",    "12:00-20:00",      "Mañana",         "9",     "4.5","$40","$120",R.drawable.forever1))
