...
import com.example.namnam_uwu.databinding.ActivityPhoneBinding
import com.example.namnam_uwu.utils.Utility
import com.example.namnam_uwu.utils.Utility.hideKeyboard
...
class PhoneActivity : AppCompatActivity() {
    ...
    private fun updateUI(user: FirebaseUser?, exception: Exception?) {
        ...
        if (exception != null) {
            ...
            showHome(user!!. phoneNumber?: "", ProvidertType.BASIC)
